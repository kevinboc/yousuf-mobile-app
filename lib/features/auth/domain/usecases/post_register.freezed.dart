...
class _$RegisterParamsImpl implements _RegisterParams {
  ...
  @override
  String toString() {
    return 'RegisterParams(email: $email, password: $password, first_name: $first_name, last_name: $last_name)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, first_name, last_name);
...
abstract class _RegisterParams implements RegisterParams {
  const factory _RegisterParams(
      ...
      final String password,
      final String first_name,
      final String last_name}) = _$RegisterParamsImpl;
